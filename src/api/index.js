...
const DEFAULT_URL = `${API_URL_APPID}/?APPID=${API_APPID}&lat=30.184688&lon=-95.206036`;
...
const DEF_N_D_H = `https://api.openweathermap.org/data/2.5/onecall?exclude=minutely&appid=${API_APPID}&lat=30.184688&lon=-95.206036`;
...
const SEARCH_DEFAULT = `${URL_UNSPLASH}?client_id=${API_UNPSLASH}&page=1&query=`;
